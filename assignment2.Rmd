...
## 4.	Create a cross-tabulation for the number of overnight hospital stays with race/ethnicity (RIDRETH3). 
Which group had the lowest proportion on inpatients? The greatest proportion of high utilizers?
...
## 5. Run the proc means and interpret the descriptive statistics for weight without shoes
and height in feet by gender (1=male and 2= female)
...
## 6. What are differences between 95% and 99% Confidence Intervals?  Report the CI's for both
variables.  What does this mean, interpret the results
...
## 7. Interpret the histogram, qqplot, ppplot, and boxplot on weight without shoes and gender. In
addition a scatterplot on weight without shoes and BMI
